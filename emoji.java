...
/*<applet code="emoji.class" width="600" height="600"></applet>*/
...
public void actionPerformed(ActionEvent ae)
	...
	public void paint(Graphics g){
          ...
          // g.fillOval(270,300,50,80);
           ...
           g.setColor(Color.BLACK);
           g.drawArc(lx-20,ly,50,40,0,110); 
           g.fillOval(lx+2,ly,lw,lh);
           g.drawArc(rx-10,ly,60,40,90,90);
           g.fillOval(rx+2,ly,lw,lh);

            g.fillArc(ax,ay,100,70,0,180);
			g.setColor(Color.YELLOW);            	
            g.fillArc(ax+2,ay+2,99,85,0,180);
